...
FIGURE_SPECS = [
    ...
    ("muestras_cutmix.png", "CutMix — ejemplo de mezcla de imágenes y etiquetas"),
    ...
    ("confusion_matrix_cnn_cutmix.png", "Matriz de confusión — CNN + CutMix"),
    ...
    ("classification_report_cnn_cutmix.png", "Classification report — CNN + CutMix"),
    ...
    ("curvas_cnn_cutmix.png", "Curvas de entrenamiento — CNN + CutMix"),
]
